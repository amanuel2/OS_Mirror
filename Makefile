GPPARAMS =  -m32 -g -Iinclude -fno-use-cxa-atexit -o3 -nostdlib -fno-builtin -std=c++11 -fno-rtti -fno-exceptions -fno-leading-underscore -Wno-write-strings -Wno-unused-label -Wno-unused-but-set-variable -ffreestanding -Wall -Werror
LDPARAMS =  -melf_i386
