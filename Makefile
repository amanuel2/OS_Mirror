...
LDPARAMS =  -melf_i386
objects = stdlib.o stdio.o kernel.o isr.o irq.o idt.o mem.o string.o serial.o timer.o gdt.o port.o bitset.o gdt_flush.o port_a.o boot.o idt_a.o isr_a.o  irq_a.o kbd.o mouse.o terminal.o vga.o 
i686 = i686-elf-
