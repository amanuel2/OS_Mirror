...
extern "C" void gdt_flush(struct gdt_ptr gp_ptr);
...
void gdt::gdt_set_gate(uint8_t num, uint64_t base, uint64_t limit, uint8_t access, uint8_t gran)
{
 Lib::Mem::memset(&gdt_ent[num], 0, sizeof(struct gdt_entry));
    ...
    gdt_ent[num].base_high = (base >> 24) & 0xFF;

    /* Setup the descriptor limits */
    gdt_ent[num].limit_low = (limit & 0xFFFF);
    gdt_ent[num].granularity = ((limit >> 16) & 0x0F);
